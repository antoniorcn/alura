...
const ContatoDetalhe : React.FC<ContatoDetalhesProps>= ( props ) => {
  ...
  return (
    <View key={"item-"+ item.id} style={[estilos.secondaryContainer, {flexDirection: "column", justifyContent: "space-between", minHeight: 150, padding: 10}]}>
      <View style={{flex: 1}}>
      ...
      <View style={{flexDirection: "row", justifyContent: "space-around", marginTop: 10}}>
        <Icon name="edit" size={28} color="black" onPress={()=>props.onEditar( item )}/>
        <Icon name="trash" size={28} color="black" onPress={()=>props.onApagar( item.id )}/>
      </View>
    </View>
  )
}
...
export default function AppVideo4_3_2() {
