...
const ListaHeader = () => (
  <View style={estilos.header}>
    <Text style={estilos.headerText}>Lista de Contatos</Text>
  </View>
);

const ListaFooter = () => (
  <View style={estilos.footer}>
    <Text style={estilos.footerText}>Alura</Text>
  </View>
);
...
export default function AppVideo4_1_1() {
  ...
  return (
    <FlatList   data={lista}
                ...
                ListHeaderComponentStyle={estilos.flatListContainer}
                ListFooterComponentStyle={estilos.flatListContainer}
